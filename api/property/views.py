        ...
        try:
            ...
            try:
                ...
                if int(step) == 1:
                    ...
                    notification_extra_data['app_content'] = 'Your property '+property_name+' is on auction.'
        ...
        try:
            ...
            if favourite_property is None:
                ...
                if serializer.is_valid():
                    ...
                    notification_extra_data['app_content'] = 'Listing added to favorites '+ data.property.property_name
                    notification_extra_data['app_content_ar'] = 'تمت إضافة القائمة إلى المفضلة '+ data.property.property_name_ar
                ...
                notification_extra_data['app_content'] = 'Listing removed from favorites '+ favourite_property.property.property_name
                notification_extra_data['app_content_ar'] = 'تمت إزالة القائمة من المفضلة '+ favourite_property.property.property_name_ar
                notification_extra_data['app_screen_type'] = None
                notification_extra_data['app_notification_image'] = 'heart-icon.png'
                notification_extra_data['app_notification_button_text'] = None
                notification_extra_data['app_notification_button_text_ar'] = None
        ...
        try:
            ...
            try:
                ...
                if is_approved and int(is_approved) == 28:
                    ...
                    notification_extra_data = {'image_name': 'success.svg', 'property_name': prop_name, 'property_name_ar': prop_name_ar, 'redirect_url': redirect_url}
                    notification_extra_data['app_content'] = 'Your property '+prop_name+' is ready for publish.'
                    notification_extra_data['app_content_ar'] = 'ممتلكاتك '+prop_name_ar+' جاهز للنشر'
                    ...
                    notification_extra_data = {'image_name': 'reject.svg', 'property_name': prop_name, 'property_name_ar': prop_name_ar, 'reason': return_reason, 'redirect_url': redirect_url}
                    notification_extra_data['app_content'] = 'Your property '+prop_name+' is returned for update[Reason: '+return_reason+']'
                    notification_extra_data['app_content_ar'] = 'ممتلكاتك '+prop_name_ar+' تم إرجاعه للتحديث[ سبب: '+return_reason+']'
                    ...
                    notification_extra_data = {'image_name': 'review.svg', 'property_name': prop_name, 'property_name_ar': prop_name_ar, 'redirect_url': redirect_url}
                    notification_extra_data['app_content'] = 'Your property '+prop_name+' is under review.'
                    notification_extra_data['app_content_ar'] = 'ممتلكاتك '+prop_name_ar+' قيد المراجعة'
                    notification_extra_data['app_screen_type'] = 6
                    notification_extra_data['app_notification_image'] = 'review.png'
                    notification_extra_data['app_notification_button_text'] = 'View'
                    notification_extra_data['app_notification_button_text_ar'] = 'منظر'
    ...
    def post(request):
        try:
            ...
            if site_id is not None and requested_user_id is not None:
                ...
                # ----------Email & Nptification to Rejected------
        ...
        try:
            ...
            with transaction.atomic():
                try:
                    ...
                    notification_extra_data['app_content'] = 'Property '+property_detail.property_name+' is relisted for bidding.'
                    notification_extra_data['app_content_ar'] = 'ممتلكاتك '+property_detail.property_name_ar+' تم إعادة إدراجه للمزايدة.'
                    notification_extra_data['app_screen_type'] = 4
                    notification_extra_data['app_notification_image'] = 'success.png'
