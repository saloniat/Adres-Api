        ...
        try:
            ...
            try:
                ...
                if outbidder and outbidder.user.id and user_id != outbidder.user.id:
                    ...
                    extra_data['app_content'] = 'You have been outbid! '+ prop_name
                    extra_data['app_content_ar'] = 'لقد تم التفوق عليك! '+ prop_name_ar
            ...
            try:
                ...
                extra_data['app_content'] = 'Your bid has been confirmed! '+ prop_name
                extra_data['app_content_ar'] = 'لقد تم تأكيد عرضك! '+ prop_name_ar
                extra_data['app_screen_type'] = 1
                ...
                if user_id != auction_data.property.agent.id:
                    extra_data['app_content'] = 'You have received one new bid! '+ prop_name
                    extra_data['app_content_ar'] = 'لقد تلقيت عرضًا جديدًا! '+ prop_name_ar
                    extra_data['app_screen_type'] = 1
                    extra_data['app_notification_image'] = 'check-icon.png'
                    extra_data['property_id'] = property_id
                    extra_data['app_notification_button_text'] = 'View'
...
class SendEnglishAuctionEmailView(APIView):
    ...
    def post(request):
        try:
            ...
            #  add notfification to buyer(outbidder)
            extra_data['image_name'] = 'check-icon.svg'
            extra_data['app_content'] = 'You are winner of Online Auction! '+ auction_data.property.property_name
            extra_data['app_content_ar'] = 'أنت الفائز بالمزاد عبر الإنترنت! '+ auction_data.property.property_name_ar
            extra_data['app_screen_type'] = 1
            extra_data['app_notification_image'] = 'check-icon.png'
            extra_data['property_id'] = property_id
            extra_data['app_notification_button_text'] = 'View'
...
class StartPurchaseOrForefitProperty(APIView):
    ...
    def post(request):
        try:
            ...
            notification_extra_data['app_content'] = 'Purchase process started for '+ auction_data.property.property_name
            notification_extra_data['app_content_ar'] = 'بدأت عملية الشراء لـ '+ auction_data.property.property_name_ar
            if process_type != 1:
                notification_extra_data['app_content'] = 'Forefit request submitted for '+ auction_data.property.property_name
                notification_extra_data['app_content_ar'] = 'تم تقديم طلب الاستفادة '+ auction_data.property.property_name_ar
            ...
            if process_type == 2:
                ...
                if latestHighBid  is not None:
                    ...
                    notification_extra_data['app_content'] = 'You are winner of Online Auction! '+ auction_data.property.property_name
                    notification_extra_data['app_content_ar'] = 'أنت الفائز بالمزاد عبر الإنترنت! '+ auction_data.property.property_name_ar
                    notification_extra_data['app_screen_type'] = 1
